...
This guide covers common workflow patterns for OpenSpec and when to use each one. For basic setup, see [Getting Started](getting-started.md). For the skill reference, see [Commands](commands.md).
...
- **Actions, not phases** - Skills are things you can do, not stages you're stuck in
...
If you want explicit scaffold-and-build skills (`/openspec-new-change`, `/openspec-continue-change`, `/openspec-ff-change`, `/openspec-verify-change`, `/openspec-bulk-archive-change`, `/openspec-onboard`), enable them with:
...
For full skill details and options, see [Commands](commands.md).
...
- [Commands](commands.md) - Full skill reference with options
