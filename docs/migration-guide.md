...
- **Active changes in `openspec/changes/`** — Completely preserved. You can continue them with OPSX skills.
...
Skill availability is profile-dependent:
...
Your in-progress changes work seamlessly with OPSX skills.
