...
- **Thinking records** — the exploration note (\`openspec/explorations/<name>.md\`) for the settled WHAT and its parked design seeds; \`<changeRoot>/design.md\` (incl. its wave skeleton) if one exists and you're revising the HOW.
