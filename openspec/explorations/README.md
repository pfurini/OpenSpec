...
| `design-tasks-pipeline-collapse.md` | **The thinker owns the formalization.** HOW: `openspec-design` writes `design.md` (wave skeleton) directly; `tasks` transcribes. Same pattern later for explore→specs. | **HOW shipped 2026-06-16.** WHAT collapse deferred — read §8.1 then §9. Fidelity check (§8.2) still owed. |
