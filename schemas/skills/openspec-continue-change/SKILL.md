...
3. **Act based on status**:
   ...
   **If artifacts are ready to create** (status shows artifacts with `status: "ready"`):
   ...
   - **Create the artifact file**:
     ...
     - Write to the `resolvedOutputPath` specified in instructions. If it is a glob pattern, choose the concrete file path using the schema instruction and planning context
