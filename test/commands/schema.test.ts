...
`;
  ...
  describe('schema fork', () => {
    it('should copy schema to project directory', async () => {
      ...
      // Get the package deep-planning schema
      const sourceDir = getSchemaDir('deep-planning', tempDir);
